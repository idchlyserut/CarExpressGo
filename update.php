...
<body class="loader-active">
    ...
    <section id="about-area" class="section-padding">
		...
		<?php
			...
			$result = mysqli_query($mysqli, "SELECT * FROM bookinginfo WHERE bookID=$bookID");

			
			while($res = mysqli_fetch_array($result))
			{
				$location = $res['location'];
				$pick_date = $res['pick_date'];
                    ...
                    <div class="booka-car-content">
                        <form method="post" action="editBook.php">
                            ...
                            <div class="pick-date bookinput-item">
                                <input id="startDate2" placeholder="Pick Date" name="pick_date" value="<?php echo $pick_date;?>" />
                            </div>

                            <div class="retern-date bookinput-item">
                                <input id="endDate2" placeholder="Return Date" name="return_date" value="<?php echo $return_date;?>" />
                            </div>

                            <div class="car-choose bookinput-item" >
                                <select class="custom-select" name="car_type" value="<?php echo $car_type;?>">
