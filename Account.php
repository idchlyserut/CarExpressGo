    ...
    <section id="page-title-area" class="section-padding overlay">
        <div class="container">
            <div class="row">
				...
				<button type="button" onclick ="location.href='Account.php';" class="btn btn-secondary">Info</button>
            ...
            <div class="col">
				...
				<!----Here supposed to start php for the registered info---->
                    ...
                    <div class="section-title  text-center">
						...
						<label><strong>Birth of Date</strong></label><br>
						<label><strong>Phone Number</strong></label><br>
						<label><strong>Employment Date</strong></label><br>
				...
				<!----Here supposed to start php for the registered info---->
                    ...
                    <div class="section-title  text-center">
						...
						<?php 
							...
							$result = mysqli_query($mysqli, "SELECT * FROM bookinginfo ORDER BY bookID DESC"); // using mysqli_query instead
			
							while($res = mysqli_fetch_array($result)) { 		
								echo "<tr>";
								
								echo "<td>".$res['location']."</td>";
								echo "<td>".$res['pick_date']."</td>";
								echo "<td>".$res['return_date']."</td>";
								echo "<td>".$res['car_type']."</td>";
								echo "<td><a href=\"update.php?id=$res[bookID]\">Edit</a> | <a href=\"cancelBook.php?id=$res[bookID]\" onClick=\"return confirm('Are you sure you want to cancel?')\">Cancel Booking</a></td>";
